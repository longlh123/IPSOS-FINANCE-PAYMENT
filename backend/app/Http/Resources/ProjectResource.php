...
class ProjectResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'internal_code' => $this->internal_code,
            'project_name' => $this->project_name,
            'travel_expense_target' => $this->projectDetails->travel_expense_target ?? null,
            'travel_expense_target_recruit' => $this->projectDetails->travel_expense_target_recruit ?? null,
            'travel_expense_target_recall' => $this->projectDetails->travel_expense_target_recall ?? null,
